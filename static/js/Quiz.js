...
const quiz_data_spanish = {
    ...
    "Las primeras tres palabras de la Constitución contienen la idea del autogobierno (de que el pueblo se": [
        "Nosotros, el pueblo"
    ],
    "¿Qué es una enmienda?": [
    ...
    "Nombre a uno de los senadores actuales del estado donde usted vive.": [
        "Las respuestas variarán. [Los residentes del Distrito de Columbia y los territorios de los Estados Unidos"
    ],
    ...
    "Dé el nombre de su representante a nivel nacional.": [
        "Las respuestas variarán. [Los residentes de territorios con delegados no votantes o los comisionados"
    ],
    ...
    "¿Cómo se llama el actual Vicepresidente de los Estados Unidos?": [
        "Visite uscis.gov/es/ciudadania/actualizacionesalexamen para saber el nombre del Vice Presidente de Estados"
    ],
    "Si el Presidente ya no puede cumplir sus funciones, ¿quién se convierte en Presidente?": [
        "el Vicepresidente"
    ],
    "Si tanto el Presidente como el Vicepresidente ya no pueden cumplir sus funciones, ¿quién se convierte en": [
        "el Presidente de la Cámara de Representantes"
    ],
    "¿Quién es el Comandante en Jefe de las Fuerzas Armadas?": [
        "el Presidente"
    ],
    "¿Quién frma los proyectos de ley para convertirlos en ley?": [
        "el Presidente"
    ],
    ...
    "¿Quién es el presidente actual de la Corte Suprema de los Estados Unidos?": [
        "Visite uscis.gov/es/ciudadania/actualizacionesalexamen para saber el nombre del Presidente del Tribunal"
    ],
    "De acuerdo a nuestra Constitución, algunos poderes pertenecen al gobierno federal. ¿Cuál es un poder": [
        "imprimir dinero",
        "declarar la guerra",
        "crear un ejército",
        "suscribir tratados"
    ],
    "De acuerdo a nuestra Constitución, algunos poderes pertenecen a los estados. ¿Cuál es un poder de los": [
        ...
        "aprobar la zonifcación y uso de la tierra"
    ],
    ...
    "¿Cuál es el partido político del Presidente actual?": [
        "Visite uscis.gov/es/ciudadania/actualizacionesalexamen para saber el partido político al que pertenece"
    ],
    "¿Cómo se llama el Presidente actual de la Cámara de Representantes?": [
        "Visite uscis.gov/es/ciudadania/actualizacionesalexamen para saber el nombre del Portavoz de la Cámara"
    ],
    ...
    "¿Cuáles son dos maneras mediante las cuales los ciudadanos americanos pueden participar en su": [
        "votar",
        "afliarse a un partido político",
        "ayudar en una campaña",
        "unirse a un grupo cívico",
        "unirse a un grupo comunitario",
        "compartir su opinión acerca de un asunto con un ofcial electo",
    ...
    "Los escritos conocidos como “Los Documentos Federalistas” respaldaron la aprobación de la": [
        "(James) Madison",
        "(Alexander) Hamilton",
        "(John) Jay",
        "Publius"
    ...
    "¿Qué suceso de gran magnitud ocurrió el 11": [
